...
public class RecyclerBanner extends FrameLayout {
    ...
    public RecyclerBanner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        defaultDrawable.setColor(ContextCompat.getColor(context, R.color.sino_white_99));
        selectedDrawable = new GradientDrawable();
        selectedDrawable.setSize(size, size);
        selectedDrawable.setCornerRadius(size);
        selectedDrawable.setColor(ContextCompat.getColor(context, R.color.sino_white));
    ...
    // 内置适配器
    private class ReyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ImageUtils.showImgUrl(datas.get(position % datas.size()).getUrl(), holder.imageView);
        }
