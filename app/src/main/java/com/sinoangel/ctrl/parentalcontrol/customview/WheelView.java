...
////            }
//////            if (position == i) {
////            itemView.setTextColor(ContextCompat.getColor(context, R.color.sino_white_99));
//////            } else {
...
//    }
    ...
    public void setBackground(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(ContextCompat.getColor(context, R.color.sino_white_11));
